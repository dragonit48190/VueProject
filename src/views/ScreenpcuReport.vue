        ...
        <div class="ps-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">SCREENPCU REPORT</li>
            </ol>
          </nav>
        </div>
      </div>
            ...
            <div class="card-body p-4">
              <div class="card-title d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                  ...
                  <h5 class="mb-0 text-primary">รายชื่อคัดกรองหญิงอายุ 30 - 70 ปี</h5>
                </div>
                <button 
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <p class="mb-1"><strong>คลินิก :</strong> คัดกรองหญิงอายุ 30 - 70 ปี</p>
      ...
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
          <h6 class="mb-0 text-uppercase text-success">
            ...
            รายชื่อคัดกรองหญิงอายุ 30 - 70 ปี 
          </h6>
          <button 
...
export default {
  ...
  methods: {
    async fetchData() {
      try {
        this.loading = true
        const res = await api.get(API_ROUTES.SCREENPCU)
    ...
    exportToExcel() {
      try {
        ...
        const excelData = [
          ['รายงานคัดกรองหญิงอายุ 30 - 70 ปี  โรงพยาบาลโพนสวรรค์'],
        ...
        XLSX.utils.book_append_sheet(wb, ws, 'SCREENPCU 30-70')
        
        // กำหนดชื่อไฟล์และดาวน์โหลด
        const fileName = `SCREENPCU_${dayjs().format('YYYYMMDD_HHmmss')}.xlsx`
