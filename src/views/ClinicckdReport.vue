        ...
        <div class="ps-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">CLINIC CKD</li>
            </ol>
          </nav>
        </div>
      </div>
            ...
            <div class="card-body p-4">
              <div class="card-title d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                  ...
                  <h5 class="mb-0 text-primary">รายชื่อผู้ป่วยโรคไตเรื้อรัง ลงทะเบียน Clinic CKD</h5>
                </div>
                <button 
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <p class="mb-1"><strong>คลินิก :</strong> โรคไตเรื้อรัง (CKD Clinic)</p>
...
export default {
  ...
  methods: {
    async fetchData() {
      try {
        this.loading = true
        const res = await api.get(API_ROUTES.CLINIC_CKD)
    ...
    exportToExcel() {
      try {
        ...
        const excelData = [
          ['รายงานลงทะเบียนผู้ป่วยโรคไตเรื้อรัง Clinic CKD โรงพยาบาลโพนสวรรค์'],
        ...
        XLSX.utils.book_append_sheet(wb, ws, 'Clinic CKD')
        
        // กำหนดชื่อไฟล์และดาวน์โหลด
        const fileName = `ClinicCKD_${dayjs().format('YYYYMMDD_HHmmss')}.xlsx`
