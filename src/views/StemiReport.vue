<template>
  <MainLayout>
      ...
      <div class="ps-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 p-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">STEMI I210 - I213 </li>
          </ol>
        </nav>
      </div>
    </div>
    ...
    <div class="row row-cols-1 row-cols-2">
      <div class="col-12">
        <h6 class="mb-0 text-uppercase">ค้นหารายชื่อแพทย์วินิจฉัย STEMI I210 - I213  </h6>
        <hr />
    ...
    <h6 class="mb-0 text-uppercase text-primary">รายชื่อแพทย์วินิจฉัย STEMI I210 - I213 โรงพยาบาลโพนสวรรค์ </h6>
    <hr />
    <div class="card">
      <div class="card-body">
...
export default {
  ...
  try {
    ...
    const title = [
      ['รายงานผู้ป่วย STEMI I210 - I213 โรงพยาบาลโพนสวรรค์'],
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'Stemi');
