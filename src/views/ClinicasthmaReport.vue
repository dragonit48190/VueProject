        ...
        <div class="ps-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">CLINIC ASTHMA</li>
            </ol>
          </nav>
        </div>
      </div>
            ...
            <div class="card-body p-4">
              <div class="card-title d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                  ...
                  <h5 class="mb-0 text-primary">รายชื่อผู้ป่วยโรคหืด ลงทะเบียน Clinic Asthma</h5>
                </div>
                <button 
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <p class="mb-1"><strong>คลินิก :</strong> โรคหืด (Asthma Clinic)</p>
...
export default {
  ...
  methods: {
    async fetchData() {
      try {
        this.loading = true
        const res = await api.get(API_ROUTES.CLINIC_ASTHMA)
    ...
    exportToExcel() {
      try {
        ...
        const excelData = [
          ['รายงานลงทะเบียนผู้ป่วยโรดหืด Clinic Asthma โรงพยาบาลโพนสวรรค์'],
        ...
        XLSX.utils.book_append_sheet(wb, ws, 'Clinic Asthma')
        
        // กำหนดชื่อไฟล์และดาวน์โหลด
        const fileName = `ClinicASTHMA_${dayjs().format('YYYYMMDD_HHmmss')}.xlsx`
