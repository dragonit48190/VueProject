<template>
  <MainLayout>
      ...
      <div class="ps-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 p-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">RE-ADMIT DM</li>
          </ol>
        </nav>
      </div>
    </div>
    ...
    <div class="row row-cols-1 row-cols-2">
      <div class="col-12">
        <h6 class="mb-0 text-uppercase">ค้นหารายชื่อแพทย์ RE-ADMIT DM</h6>
        <hr />
    ...
    <h6 class="mb-0 text-uppercase text-primary">รายชื่อแพทย์ RE-ADMIT DM โรงพยาบาลโพนสวรรค์ </h6>
    <hr />
    <div class="card">
      <div class="card-body">
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: 'Age', value: 'age' },
        { text: 'First_ICD', value: 'first_icd' },
        { text: 'ชื่อโรค', value: 'first_icdname' },
        { text: 'วันที่กลับ', value: 'dchdate' },
        { text: 'AN-ล่าสุด', value: 'last_an' },
        { text: 'วันที่รับ', value: 'regdate' },
        { text: 'รหัสโรค', value: 'last_icd' },
        { text: 'ICDNAME', value: 'icdname' },
        { text: 'จำนวนวัน', value: 'visit' },
        { text: 'Discharge_status', value: 'status' }
  ...
  methods: {
    async fetchData() {
      ...
      try {
        ...
        const res = await api.get(API_ROUTES.READMITDM, {
  ...
  try {
    ...
    const title = [
      ['รายงานผู้ป่วย RE-ADMIT DM โรงพยาบาลโพนสวรรค์'],
    ...
    const fileName = `READMITDM${d1}_to_${d2}.xlsx`;
