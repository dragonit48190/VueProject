<template>
  <MainLayout>
      ...
      <div class="ps-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 p-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">IPD REFER </li>
          </ol>
        </nav>
      </div>
    </div>
    ...
    <div class="row row-cols-1 row-cols-2">
      <div class="col-12">
        <h6 class="mb-0 text-uppercase">ค้นหารายชื่อผู้ป่วยใน ส่งต่อสถานพยาบาลอื่น IPD REFER </h6>
        <hr />
    ...
    <h6 class="mb-0 text-uppercase text-primary">รายชื่อแพทย์ส่งต่อสถานบริการอื่น  IPD REFER โรงพยาบาลโพนสวรรค์ </h6>
    <hr />
    <div class="card">
      <div class="card-body">
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: 'Age', value: 'age' },
        { text: 'วันที่', value: 'refer_date' },
        { text: 'ICD', value: 'icd' },
        { text: 'ICDNAME', value: 'icdname' },
        { text: 'จุดส่ง', value: 'department' },
  ...
  methods: {
    async fetchData() {
      ...
      try {
        ...
        const res = await api.get(API_ROUTES.IPD_REFER, {
  ...
  try {
    ...
    const title = [
      ['รายงานผู้ป่วยใน IPD REFER โรงพยาบาลโพนสวรรค์'],
    ...
    const headers = [
      ['ลำดับ', 'HN', 'CID', 'ชื่อ-สกุล', 'อายุ', 'วันที่', 'ICD', 'ICDNAME', 'จุดส่ง', 'เลขที่', 'หมู่', 'ตำบล', 'รพ.สต.']
    ];
