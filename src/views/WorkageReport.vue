        ...
        <div class="ps-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">WORKAGE REPORT</li>
            </ol>
          </nav>
        </div>
      </div>
            ...
            <div class="card-body p-4">
              <div class="card-title d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                  ...
                  <h5 class="mb-0 text-primary">รายชื่อกลุ่มอายุ 22 - 59 ปี</h5>
                </div>
                <button 
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <p class="mb-1"><strong>กลุ่ม :</strong> วัยทำงานอายุ 22 - 59 ปี</p>
...
export default {
  ...
  methods: {
    async fetchData() {
      try {
        this.loading = true
        const res = await api.get(API_ROUTES.WORKAGE)
    ...
    exportToExcel() {
      try {
        ...
        const excelData = [
          ['รายงานกลุ่มอายุ 22 - 59 ปี  โรงพยาบาลโพนสวรรค์'],
        ...
        XLSX.utils.book_append_sheet(wb, ws, ' Workage 22-59')
        
        // กำหนดชื่อไฟล์และดาวน์โหลด
        const fileName = `Workage_${dayjs().format('YYYYMMDD_HHmmss')}.xlsx`
