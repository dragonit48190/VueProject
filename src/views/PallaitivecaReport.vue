<template>
  <MainLayout>
      ...
      <div class="ps-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 p-0">
            ...
            <li class="breadcrumb-item active" aria-current="page"> PALLAITIVE CA</li>
          </ol>
        </nav>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-12">
        <h6 class="mb-0 text-uppercase">ค้นหารายชื่อแพทย์วินิจฉัย มะเร็ง CA C00 - C96</h6>
        <hr />
          ...
          <div class="card-body p-4">
            ...
            <div v-if="patients.length > 0" class="mt-3">
              <div class="alert alert-primary py-2">
                ...
                พบรายชื่อแพทย์วินิจฉัยมะเร็ง <strong>{{ patients.length.toLocaleString() }}</strong> ราย 
    ...
    <div class="card">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h6 class="mb-0 text-uppercase text-primary">
          ...
          รายชื่อแพทย์วินิจฉัยมะเร็ง โรงพยาบาลโพนสวรรค์
  ...
  methods: {
    async fetchData() {
      ...
      try {
        ...
        const res = await api.get(API_ROUTES.PALLAITIVECA, {
    ...
    exportToExcel() {
      try {
        ...
        const excelData = [
          ['รายงานแพทย์วินิจฉัยมะเร็ง  โรงพยาบาลโพนสวรรค์'],  
        ...
        XLSX.utils.book_append_sheet(wb, ws, 'Pallaitive CA')
        
        // กำหนดชื่อไฟล์และดาวน์โหลด
        const fileName = `PALLAITIVECA_${dayjs(this.dateRaw1).format('YYYYMMDD')}_to_${dayjs(this.dateRaw2).format('YYYYMMDD')}.xlsx`
