<template>
  <MainLayout>
      ...
      <div class="ps-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 p-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">Re-ADMIT 28 วัน</li>
          </ol>
        </nav>
      </div>
    </div>
    ...
    <div class="row row-cols-1 row-cols-2">
      <div class="col-12">
        <h6 class="mb-0 text-uppercase">ค้นหารายชื่อแพทย์ Re-ADMIT 28 วัน</h6>
        <hr />
    ...
    <h6 class="mb-0 text-uppercase text-primary">รายชื่อแพทย์ Re-ADMIT โรงพยาบาลโพนสวรรค์ </h6>
    <hr />
    <div class="card">
      <div class="card-body">
...
export default {
  ...
  methods: {
    async fetchData() {
      ...
      try {
        ...
        const res = await api.get(API_ROUTES.RE_ADMIT, {
  ...
  try {
    ...
    const title = [
      ['รายงานผู้ป่วย RE_ADMIT โรงพยาบาลโพนสวรรค์'],
    ...
    const fileName = `RE_ADMIT${d1}_to_${d2}.xlsx`;
