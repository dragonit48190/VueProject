<template>
  <MainLayout>
      ...
      <div class="ps-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 p-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">SEPSIS A419 : R579 : R651 ADMIT</li>
          </ol>
        </nav>
      </div>
    </div>
    ...
    <div class="row row-cols-1 row-cols-2">
      <div class="col-12">
        <h6 class="mb-0 text-uppercase">ค้นหารายชื่อแพทย์วินิจฉัย SEPSIS A419 : R579 : R651 ADMIT </h6>
        <hr />
    ...
    <h6 class="mb-0 text-uppercase text-primary">รายชื่อแพทย์วินิจฉัย SEPSIS A419 : R579 : R651 ADMIT โรงพยาบาลโพนสวรรค์ </h6>
    <hr />
    <div class="card">
      <div class="card-body">
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: 'จำหน่าย', value: 'dchdate' },
        { text: 'วันนอน', value: 'admdate' },
        { text: 'ICD', value: 'icd' },
  ...
  methods: {
    async fetchData() {
      ...
      try {
        ...
        const res = await api.get(API_ROUTES.SEPSIS_ADMIT, {
  ...
  try {
    ...
    const title = [
      ['รายงานผู้ป่วย SEPSIS A419 : R579 : R651 ADMIT โรงพยาบาลโพนสวรรค์'],
    ...
    const headers = [
      ['ลำดับ', 'AN', 'HN', 'ชื่อ-สกุล', 'อายุ', 'วันที่รับ', 'วันที่จำหน่าย', 'วันนอน','ICD', 'ICDNAME', 'สิทธิ', 'ค่ารักษา','บ้านเลขที่', 'หมู่', 'ตำบล']
    ];
