...
router.get('/clinicasthma', (req, res) => {
  const sql = `
    SELECT
      p.hn,
      p.cid,
      ...
      c.begin_year,
      cl.NAME AS clinic,
      cs.clinic_member_status_name AS status,
      p.addrpart AS num,
      p.moopart AS moo,
      t.NAME AS tum,
      CASE
    ...
    LEFT JOIN clinic_member_status cs ON c.clinic_member_status_id = cs.clinic_member_status_id
